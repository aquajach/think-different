Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :side=>"300x400>"}
  ...
  # config.dragonfly_secret = "81b92ae8828ed13bc0042181a478e47acb700e0bc9eafb30"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/chensongyong/Sites/workspace/think-different/public/system/refinery/images"
